...
- (void)gotoSecondMenuWithText:(NSString*)text
{
    ...
    else if ([text isEqualToString:@"MV"]) {
        [self performSegueWithIdentifier:@"page2MV" sender:nil];
    }
}
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        [LSPlayBottomView sharedPlayBottomView].transform=CGAffineTransformIdentity;
    }];
}
